...
/***/ function(module, exports) {
	...
	exports.readableAttributes = readableAttributes;
	var PRIMARY_STATS = exports.PRIMARY_STATS = [{ label: 'Strength', bonus: [] }];

	var attributeMap = [{ short: 'str', long: 'Strength' }, { short: 'dex', long: 'Dexterity' }, { short: 'con', long: 'Constitution' }, { short: 'int', long: 'Intelligence' }, { short: 'wis', long: 'Wisdom' }, { short: 'cha', long: 'Charisma' }, { short: 'any', long: 'Any' }];

	function readableAttributes(attributes) {
	  var readable = arguments.length <= 1 || arguments[1] === undefined ? [] : arguments[1];
	...
	var raceDetails = exports.raceDetails = ['traits', 'perks', 'vision', 'languages'];

	var raceList = exports.raceList = [{
	  name: 'Dwarf',
	  attrs: [0, 2, 0, 0, 0, 0, 0],
	  vision: 'Darkvision',
	  subraces: [{
	    name: 'Mountain Dwarf',
	    attrs: [2, 2, 0, 0, 0, 0, 0],
	    perks: [{ value: ['light', 'medium'], label: 'Armor' }]
	  }, {
	    name: 'Hill Dwarf',
	    attrs: [0, 2, 0, 0, 0, 1, 0]
	  }]
	  ...
	  subraces: [{
	    ...
	    perks: [{ value: ['Something'], label: 'perk' }]
	  }, {
	    name: 'High Elf',
	    attrs: [2, 0, 0, 2, 0, 0, 0],
	    weapons: ['shortbow', 'longbow', 'shortsword', 'longsword'],
	    perks: [{ value: ['Something Else'], label: 'perk' }]
	  }]
	}, {
	  name: 'Fake Race',
	  attrs: [2, 0, 0, 1, 0, 0, 0],
	...
	var sampleRaceJSON = exports.sampleRaceJSON = {
	  races: [{
	    name: 'Tiefling',
	    attrs: [0, 0, 0, 1, 0, 2, 0],
	    tags: [{ type: 'attributes', value: [0, 0, 0, 1, 0, 2, 0] }, { type: 'traits', value: 'Infernal Legacy' }, { type: 'traits', value: 'Darkvision' }, { type: 'resistances', value: 'fire' }, { type: 'languages', value: 'Infernal' }],
	    subraces: []
	  }, {
	    name: 'Dragonborn',
	    attrs: [2, 0, 0, 0, 0, 1, 0],
	    ...
	    traits: [{ category: 'advantages', value: ['poison'] }, { category: 'resistances', value: ['poison'] }, { category: 'vision', value: ['darkvision'] }, { category: 'languages', value: ['Common', 'Dwarven'] }],
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'footer',
	      { className: 'footer', role: 'contentinfo', id: 'player-dashboard' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RaceList = exports.RaceChoice = undefined;
	...
	*/
	...
	var RaceChoice = exports.RaceChoice = _react2.default.createClass({
	  displayName: 'RaceChoice',
	  render: function render() {
	    ...
	    if (race) {
	      name = race.name;
	      attrs = (0, _constants.readableAttributes)(race.attrs).map(function (attr) {
	        return _react2.default.createElement(
	          'li',
	          { key: attr.short },
	          attr.long,
	      ...
	      details = _constants.raceDetails.filter(function (key) {
	        return race[key];
	      }).map(function (key) {
	        var fields = race[key].map(function (field) {
	          return _react2.default.createElement(
	            'div',
	            { key: key, className: key + '-list' },
	            field.label,
	            ': ',
	            field.value.join(', ')
	          );
	...
	var SubRace = _react2.default.createClass({
	  displayName: 'SubRace',
	  render: function render() {
	    var name = this.props.name;
	...
	var Race = _react2.default.createClass({
	  displayName: 'Race',
	  render: function render() {
	    var style = {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'primary-race' },
	      _react2.default.createElement(
	        'div',
	        { onClick: this.props.toggleRace.bind(null, this.props.isActive, this.props.i) },
	        this.props.name
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'subraces', style: style },
	        this.props.children
	      )
	    );
	  }
	...
	var RaceList = exports.RaceList = _react2.default.createClass({
	  ...
	  onEnter: function onEnter(race) {
	    if (this.state.selected) return;
	    this.setState({ highlighted: true, race: race });
	  },
	  onLeave: function onLeave(race) {
	    if (!this.state.selected) {
	      this.setState({ highlighted: false, race: null });
	    }
	  },
	  onSelect: function onSelect(race) {
	    if (!this.state.race || race.name !== this.state.race.name) {
	      this.setState({ race: race, selected: true });
	    } else if (race.name === this.state.race.name && this.state.selected) {
	      this.setState({ race: null, selected: false });
	    } else {
	      this.setState({ selected: true, race: race });
	    }
	  },
	  toggleRace: function toggleRace(activeRaceNode, idx) {
	    if (!activeRaceNode) {
	  ...
	  render: function render() {
	    ...
	    var onLeave = this.onLeave;
	    var onSelect = this.onSelect;
	    var activeRaceNode = this.state.activeRaceNode;
	    var selectedRace = this.state.race;
	    var races = _constants.raceList.map(function (race, ridx) {
	      var subraces = race.subraces.map(function (subrace, sidx) {
	        return _react2.default.createElement(SubRace, _extends({ parentRace: ridx, onEnter: onEnter, onLeave: onLeave, onSelect: onSelect }, subrace, { key: 'subrace-' + sidx }));
	      });
	      return _react2.default.createElement(
	        Race,
	        _extends({ toggleRace: _this.toggleRace, i: ridx, isActive: ridx === activeRaceNode, key: 'race-' + ridx }, race),
	        subraces
	      );
	    });
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'selected-race' },
	        _react2.default.createElement(RaceChoice, { race: selectedRace })
	      ),
	      _react2.default.createElement(
	        'div',
	        { className: 'race-list' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.e = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _raceList = __webpack_require__(88);

	var _constants = __webpack_require__(52);

	var _playerPreview = __webpack_require__(87);

	var _playerPreview2 = _interopRequireDefault(_playerPreview);
	...
	var App = _react2.default.createClass({
	  ...
	  _selectRace: function _selectRace(selectedRace) {
	    this.setState({ selectedRace: selectedRace });
	  },
	  _reveal: function _reveal(activeState, raceProps) {
	    this.setState({ activeRace: activeState ? raceProps : null });
	  },
	  _updateScore: function _updateScore(score, parent, name, a, b) {
	    var _parent$map = parent.map(function (i) {
	      return i - 1;
	    });

	    var _parent$map2 = _slicedToArray(_parent$map, 2);

	    var x = _parent$map2[0];
	    var y = _parent$map2[1];
	    ...
	    this.setState({ score: score, activeCell: activeCell, parent: parent });
	  },
	  updateChoice: function updateChoice(data) {
	    ...
	    if (this.state.choice.selected && data.name === this.state.choice.data.name) {
	      ...
	      this.setState({ choice: { selected: selected, data: data } });
	    }
	  },
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_raceList.RaceList, { updateChoice: this.updateChoice }),
	      _react2.default.createElement(_playerPreview2.default, null)
	    );
	  }
	});

	function showReact() {
	  _reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('render'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.constants = exports.adapter = undefined;
